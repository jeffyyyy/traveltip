...
export const TRIP_DAYS: TripDay[] = [
  ...
  },
  {
    ...
    activities: [
      ...
      { time: '11:00 AM', title: 'Ronda Old Town', description: "Puente Nuevo bridge over El Tajo gorge, Spain's oldest bullring", type: 'sightseeing' },
      { time: '1:00 PM', title: 'Lunch in Ronda', type: 'food' },
      { time: '3:00 PM', title: 'Explore more of Ronda', description: 'Arab baths, old town streets, viewpoints', type: 'sightseeing' },
